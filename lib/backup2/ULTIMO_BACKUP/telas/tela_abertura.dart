...
class _TelaAberturaState extends State<TelaAbertura>
  ...
  Widget build(BuildContext context) {
    ...
    const corFundo = Color(0xFF4338CA); 
        ...
        child: SafeArea(
          child: Stack(
            children: [
              ...
              // ====================================================================
              // RODAPÉ: A BARRINHA DE CARREGAMENTO ANIMADA
              // ====================================================================
              Positioned(
                bottom: 50,
                left: 0,
                  ...
                  child: Column(
                    children: [
                      ...
                      AnimatedBuilder(
                        ...
                        builder: (context, child) {
                          return CustomPaint(
                            size: const Size(60, 4), // Tamanho da barrinha
                      ...
                      // O texto
                      Text(
                        'carregando', // Minúsculo como na sua imagem
                        style: GoogleFonts.inter(
                          fontSize: 13,
